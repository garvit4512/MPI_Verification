...
class pCFGIterator : public pCFG_FWDataflow
{
    ...
    bool filterSendRecv(pCFGNode&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&);
    bool matchSendRecv(pCFGNode&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&);
    bool matchStar(pCFGNode&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&, set<unsigned int>&);
